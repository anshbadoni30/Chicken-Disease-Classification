...
def create_directories(path_to_directories:list, verbose=True):
    ...
    Args:
        ...
        ignore_log (bool,optional): if multiple dirs to be created. Defaults to False
    """
...
def save_bin(data:Any, path:Path):
    ...
    Args: data(Any): data saved as binary
...
def load_bin(path:Path)->Any:
    ...
    Returns: Any: data loaded from binary file
    """
